# Interview / recording session wrap

**When:** the transcript shows an interview or recording session ending —
phrases like "that's a wrap", "we got it", "stopping the recording",
"thanks so much for your time", followed by goodbyes and then silence or an
app switch away from Zoom.
